        ...
        <div class="row playlist-area">
            <div class="mix col-lg-3 col-md-4 col-sm-6 genres">
                <div class="playlist-item">
                    <img src="{{asset('frontend/img/playlist/1.jpg')}}" alt="">
                    <h5>Live Concerts</h5>
                </div>
            </div>
            ...
            <div class="mix col-lg-3 col-md-4 col-sm-6 movies">
                <div class="playlist-item">
                    <img src="{{asset('frontend/img/playlist/3.jpg')}}" alt="">
                    <h5>Recorded Live</h5>
                </div>
            </div>
            <div class="mix col-lg-3 col-md-4 col-sm-6 labels">
                <div class="playlist-item">
                    <img src="{{asset('frontend/img/playlist/4.jpg')}}" alt="">
                    <h5>Oldies</h5>
                </div>
            </div>
            <div class="mix col-lg-3 col-md-4 col-sm-6 genres">
                <div class="playlist-item">
                    <img src="{{asset('frontend/img/playlist/5.jpg')}}" alt="">
                    <h5>Rock & Roll</h5>
                </div>
            </div>
            <div class="mix col-lg-3 col-md-4 col-sm-6 artists">
                <div class="playlist-item">
                    <img src="{{asset('frontend/img/playlist/6.jpg')}}" alt="">
                    <h5>Classic Music</h5>
                </div>
            </div>
            <div class="mix col-lg-3 col-md-4 col-sm-6 movies">
            ...
            <div class="mix col-lg-3 col-md-4 col-sm-6 labels">
                <div class="playlist-item">
                    <img src="{{asset('frontend/img/playlist/8.jpg')}}" alt="">
                    <h5>Alternative</h5>
                </div>
            </div>
            <div class="mix col-lg-3 col-md-4 col-sm-6 genres">
            ...
            <div class="mix col-lg-3 col-md-4 col-sm-6 artists">
                <div class="playlist-item">
                    <img src="{{asset('frontend/img/playlist/10.jpg')}}" alt="">
                    <h5>EDM</h5>
                </div>
            </div>
            <div class="mix col-lg-3 col-md-4 col-sm-6 movies">
                <div class="playlist-item">
                    <img src="{{asset('frontend/img/playlist/11.jpg')}}" alt="">
                    <h5>Pop Culture</h5>
                </div>
            </div>
            <div class="mix col-lg-3 col-md-4 col-sm-6 labels">
                <div class="playlist-item">
                    <img src="{{asset('frontend/img/playlist/12.jpg')}}" alt="">
                    <h5>The 90’s</h5>
                </div>
            </div>
            <div class="mix col-lg-3 col-md-4 col-sm-6 genres">
                <div class="playlist-item">
                    <img src="{{asset('frontend/img/playlist/13.jpg')}}" alt="">
                    <h5>Jass & Blues</h5>
                </div>
            </div>
            <div class="mix col-lg-3 col-md-4 col-sm-6 artists">
                <div class="playlist-item">
                    <img src="{{asset('frontend/img/playlist/14.jpg')}}" alt="">
                    <h5>Dj Sets</h5>
                </div>
            </div>
            <div class="mix col-lg-3 col-md-4 col-sm-6 movies">
                <div class="playlist-item">
                    <img src="{{asset('frontend/img/playlist/15.jpg')}}" alt="">
                    <h5>Minimal</h5>
                </div>
            </div>
        </div>
