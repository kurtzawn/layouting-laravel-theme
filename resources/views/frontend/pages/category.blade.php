    ...
    <div class="container">
        ...
        <div class="song-item">
            <div class="row">
                <div class="col-lg-4">
                    <div class="song-info-box">
                        <img src="{{asset('frontend/img/songs/3.jpg')}}" alt="">
                        <div class="song-info">
                            <h4>Indeed</h4>
                            <p>In the park</p>
                        </div>
        ...
        <div class="song-item">
            <div class="row">
                <div class="col-lg-4">
                    <div class="song-info-box">
                        <img src="{{asset('frontend/img/songs/4.jpg')}}" alt="">
                        <div class="song-info">
                            <h4>Moon man</h4>
                            <p>Dream in colors</p>
                        </div>
        ...
        <div class="song-item">
            <div class="row">
                <div class="col-lg-4">
                    <div class="song-info-box">
                        <img src="{{asset('frontend/img/songs/5.jpg')}}" alt="">
                        <div class="song-info">
                            <h4>Neens</h4>
                            <p>One Night in Ibiza</p>
                        </div>
        ...
        <div class="song-item">
            <div class="row">
                <div class="col-lg-4">
                    <div class="song-info-box">
                        <img src="{{asset('frontend/img/songs/6.jpg')}}" alt="">
                        <div class="song-info">
                            <h4>The Smiths</h4>
                            <p>Dream in colors</p>
                        </div>
        ...
        <div class="song-item">
            <div class="row">
                <div class="col-lg-4">
                    <div class="song-info-box">
                        <img src="{{asset('frontend/img/songs/7.jpg')}}" alt="">
                        <div class="song-info">
                            <h4>Don’t Stop</h4>
        ...
        <div class="song-item">
            <div class="row">
                <div class="col-lg-4">
                    <div class="song-info-box">
                        <img src="{{asset('frontend/img/songs/8.jpg')}}" alt="">
                        <div class="song-info">
                            <h4>The Reds</h4>
